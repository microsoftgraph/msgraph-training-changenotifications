...
1. Open the **Startup.cs** file and comment out the following line to disable ssl redirection.
...
1. Open the **Startup.cs** file. Locate the method `ConfigureServices()` method & replace it with the following code:
...
1. Open the **appsettings.json** file and replace the content the following.
...
1. The application requires a new controller to process the subscription and notification.
